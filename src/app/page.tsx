...
//     { label: 'Sell E-Waste', href: '/ewaste' },
...
//           <div className="flex gap-6">
//             {/* ✅ Legal pages */}
//             <Link href="/privacy-policy" className="text-white/20 hover:text-white/50 text-xs transition-colors">Privacy Policy</Link>
//             <Link href="/terms-of-service" className="text-white/20 hover:text-white/50 text-xs transition-colors">Terms of Service</Link>
//           </div>
//         </div>
//       </div>
//     </footer>
...
export const metadata: Metadata = {
  title: "iPhone — Engineered to Perfection",
  description: "Experience the device that redefines what a smartphone can be.",
};
...
export default function LandingPage() {
  return (
    <main className="landing-main">
      ...
      {/* Below the fold — optional continuation */}
      <section className="below-fold">
        <h3 className="below-title">Ready to own it?</h3>
        <p className="below-sub">
          Available now. Free shipping. Hassle-free returns.
        </p>
