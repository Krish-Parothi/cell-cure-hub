...
//   return (
//     <section className="relative px-6 py-24 md:py-36 bg-[#050505] border-t border-white/5 select-none overflow-hidden">
//       {/* Background glow */}
...
//           <span className="text-xs tracking-[0.3em] uppercase font-bold text-[#FF6B35] font-sans">Early Access Open</span>
//         </div>
        
//         <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter uppercase leading-[0.9] mb-6">
//           Be the <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B35] to-[#FF9A6C]">Early Bird</span>
//         </h2>
        
//         <p className="text-base md:text-xl text-white/50 mb-12 max-w-2xl mx-auto font-medium font-sans leading-relaxed">
//           Reserve your spot now and get a flat <span className="text-white font-bold">15% discount</span> on your first premium device repair when we launch. No hidden terms, just our reward for trusting us early.
//         </p>
        
//         <Link 
//           href="/early-bird"
//           className="group inline-flex items-center justify-center gap-3 px-8 py-5 rounded-2xl font-black text-sm tracking-[0.2em] transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_40px_rgba(255,107,53,0.2)] hover:shadow-[0_0_60px_rgba(255,107,53,0.4)]"
//           style={{ background: "linear-gradient(135deg, #FF6B35 0%, #FF9A6C 100%)", color: "#fff", textTransform: 'uppercase' }}
//         >
