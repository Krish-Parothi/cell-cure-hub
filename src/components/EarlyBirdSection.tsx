...
export default function EarlyBirdSection() {
  ...
  return (
    <section
      style={{ background: "#080808", borderTop: "1px solid rgba(255,255,255,0.06)" }}
      // FIX: reduced horizontal padding on mobile, less vertical padding
      className="px-4 sm:px-6 py-20 sm:py-28 md:py-40"
    >
      {/* FIX: max-w-2xl with full width on small screens */}
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-12">
          {/* FIX: text-4xl on mobile → text-5xl sm → text-6xl md */}
          <h2
        ...
        {!submitted ? (
          // FIX: padding p-5 on mobile, p-8 sm, p-10 md
          <div
            ...
            {[
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  value={form[field.key as keyof typeof form]}
                  onChange={(e) => setForm({ ...form, [field.key]: e.target.value })}
                  // FIX: text-base on mobile prevents iOS auto-zoom (zoom happens when font < 16px)
          ...
          >
            ...
            >
              Hey{" "}
              <strong style={{ color: "rgba(255,255,255,0.8)" }}>{form.name}</strong>, your 15% off is saved. Show
              this page when you walk in — we&apos;ll take care of the rest.
            </p>
          </div>
        )}
        ...
        <div className="mt-12 sm:mt-16">
          ...
          {showTable && entries.length > 0 && (
            // FIX: overflow-x-auto already present — good. Added -mx-4 sm:mx-0 so table scrolls within padding
