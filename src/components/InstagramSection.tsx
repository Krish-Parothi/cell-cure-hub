...
// /**
//  * No forced 9:16 crop server-side — deliver wide image at high res,
//  * let CSS object-fit + object-position do the visual crop.
//  * This prevents the stretch artifact entirely.
//  */
// function ikUrl(filename: string) {
//   return `${IK_BASE}/${filename}?tr=w-800,f-auto,q-85,e-sharpen`;
// }
...
//   imageAlt: string;
//   /**
//    * CSS object-position — tune per card so the key subject
//    * (face / text / action) stays visible in the tall crop.
//    * Format: "X% Y%" — increase Y% to push image UP (show lower content),
//    *                    decrease Y% to pull image DOWN (show upper content).
//    */
//   pos: string;
//   href: string;
// }
...
//     filename: 'mobile-repair.webp',
//     imageAlt: 'Startup idea to best decision',
//     pos: '60% 20%',   // show right side of frame (person) + pull image down slightly
//   },
//   {
//     id: 'water-damage',
//     type: 'reel',
...
//     filename: 'studio.webp',
//     imageAlt: 'Startup journey Cell Cure Hub',
//     pos: '50% 15%',   // heavy top text — show upper region
//   },
//   {
//     id: 'cleanroom',
//     type: 'reel',
...
//     filename: 'office.webp',
//     imageAlt: 'Inspiration and trust Cell Cure Hub',
//     pos: '50% 10%',   // office shot — anchor to top so logo + face visible
//   },
//   {
//     id: 'satisfaction',
//     type: 'reel',
...
//     filename: 'doorstep.webp',
//     imageAlt: 'Nagpur startup community Cell Cure Hub',
//     pos: '70% 20%',   // person on right holding package — shift right + up
//   },
// ];
...
//             >
//               {/*
//                * KEY FIX: object-cover + custom object-position per card.
//                * Image is delivered at full landscape resolution (w-800),
//                * CSS crops it visually into the portrait card without any
//                * server-side stretch. Each card's `pos` anchors the crop.
//                */}
//               <img
//                 src={ikUrl(post.filename)}
//                 alt={post.imageAlt}
...
//                 style={{ backgroundImage: 'linear-gradient(to top, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.4) 40%, rgba(0,0,0,0.08) 100%)' }}
//               />
//               {/* Top vignette */}
//               <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-black/50 to-transparent pointer-events-none" />
